...
class Usuarios extends BaseController
{
    ...
    public function index()
    {
        ...
        $usuarios = $this->usuariosModel->select('usuarios.*, s.nombre AS sucursal, r.nombre AS rol')
    ...
    public function create()
    {
        ...
        $post = $this->request->getPost(['usuario', 'nombre', 'password', 'id_sucursal', 'id_rol']);
    ...
    public function update($id = null)
    {
        ...
        $post = $this->request->getPost(['usuario', 'nombre', 'id_sucursal', 'id_rol']);
